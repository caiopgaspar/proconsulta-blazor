...
namespace ProConsulta.Data
{
    public class DbInitializer
    {
        ...
        internal void seed()
        {
            ...
            (
                new Especialidade { Id = 1, Nome = "Cardiologia", Descricao = "Especialidade médica que trata doenças do coração e sistema cardiovascular." },
                new Especialidade { Id = 2, Nome = "Dermatologia", Descricao = "Especialidade médica que trata doenças de pele, cabelo e unhas." },
                ...
                new Especialidade { Id = 7, Nome = "Psiquiatria", Descricao = "Especialidade médica que trata doenças mentais e distúrbios emocionais." },
                new Especialidade { Id = 8, Nome = "Oftalmologia", Descricao = "Especialidade médica que trata doenças nos olhos." },
